...
void HeavyFoe::typeSetup(float level){
    ...
    strokeSprite = ofxSpriteSheetRenderer::makeSprite(0, 14, 5, 9, 13, frameTime, -1, -1, 1, 64);
    fillSprite = ofxSpriteSheetRenderer::makeSprite(0, 27, 5, 9, 13, frameTime, -1, -1, 1, 64);
}
